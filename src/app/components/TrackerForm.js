...
function TrackerForm() {
  ...
  return (
    <>
    {authStatus ? (
    <form onSubmit={handleSubmit} className='flex md:flex-row flex-col w-full gap-2 items-center justify-center  '>
<select
  name="name"
...
/>
       ...
       <button type='submit' className='bg-amber-600/50 text-white/70 rounded-sm shadow-sm pt-2 pb-2 pl-4 pr-4  m-5 mb-2 md:mb-0'>
        ...
        <div className="flex flex-col items-center justify-center h-svh w-full max-w-md mx-auto bg-white  dark:bg-black/30 dark:shadow-white/10">
